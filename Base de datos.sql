...
FOREIGN KEY (ID_USUARIO) REFERENCES AspNetUsers(id)ON DELETE NO ACTION
ON UPDATE NO ACTION,
FOREIGN KEY (ID_METODO) REFERENCES METODO_PAGO(ID_METODO)ON DELETE NO ACTION
ON UPDATE NO ACTION,
FOREIGN KEY (ID_DOMICILIO) REFERENCES DOMICILIO(ID_DOMICILIO)ON DELETE NO ACTION
ON UPDATE NO ACTION);
...
FOREIGN KEY (ID_FACTURA) REFERENCES FACTURA(ID_FACTURA)ON DELETE NO ACTION
ON UPDATE NO ACTION,
FOREIGN KEY (ID_CONSOLA) REFERENCES CONSOLA(ID_CONSOLA)ON DELETE NO ACTION
ON UPDATE NO ACTION,
FOREIGN KEY (ID_VIDEOJUEGO) REFERENCES VIDEOJUEGO(ID_VIDEOJUEGO)ON DELETE NO ACTION
