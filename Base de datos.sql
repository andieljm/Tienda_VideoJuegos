...
--ejecutar scrips despues de eliminar detalle factura
alter table FACTURA drop constraint FK__FACTURA__ID_USUA__3864608B;
alter table FACTURA drop constraint FK__FACTURA__ID_METO__395884C4; 
alter table FACTURA drop constraint FK__FACTURA__ID_DOMI__3A4CA8FD;
drop table FACTURA
...
---primero ejecutar los siguientes comandos para modificar la tabla factura
alter table DETALLE_FACTURA drop constraint FK__DETALLE_F__ID_FA__3D2915A8;
alter table DETALLE_FACTURA drop constraint FK__DETALLE_F__ID_CO__3E1D39E1;
alter table DETALLE_FACTURA drop constraint FK__DETALLE_F__ID_VI__3F115E1A;
alter table DETALLE_FACTURA drop constraint FK__DETALLE_F__ID_PE__40058253;
...
CREATE TABLE DETALLE_FACTURA(
ID_DETALLE INT identity primary key NOT NULL,
cantidad INT NOT NULL,
precio DECIMAL(10,2) NOT NULL,
ID_FACTURA INT NOT NULL,
ID_CONSOLA INT,
